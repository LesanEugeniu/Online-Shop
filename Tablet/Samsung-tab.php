...
<head>
    ...
    <link rel="stylesheet" href="../css/samsung-tab.css">
...
<body>
    ...
    <div class="container-1 container-black">
        <div class="GlaxyTabS8Ultra text-big-width s8ultra">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    ...
                    <input class="btn-buy-white btn-buy-GalaxyTabS8Ultra" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-GalaxyTabS8Ultra">Learn more ></a>
            </div>
        </div>
        <img class="GlaxyTabS8Ultra-Image" src="<?php
                                                echo $image;
                                                ?>" alt="GlaxyTabS8Ultra">
    </div>

    <div class="container-1">
        <img class="GalaxyTabA7Lite-Image" src="<?php
                                                $product_id = 21;
                                                include '../php/product.php';
                                                echo $image;
                                                ?>" alt="GalaxyTabA7Lite" data-aos="fade-right" data-aos-duration="1500">
        <div class="GlaxyTabS8Ultra text-big-width" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white black btn-buy-GalaxyTabA7Lite" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-GalaxyTabA7Lite">Learn more ></a>
            </div>
        </div>
    </div>
    ...
    <div class="container-1 container-black">
        <div class="GlaxyTabS8Ultra text-big-width" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white btn-buy-GalaxyTabS6Lite" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-GalaxyTabS6Lite">Learn more ></a>
            </div>
        </div>
        <img class="GalaxyTabS6Lite-Image" src="<?php
                                                echo $image;
                                                ?>" alt="GalaxyTabS6Lite" data-aos="fade-up" data-aos-duration="1500">
    </div>

    <?php
    include '../php/product.php';
    $sql = mysqli_query($conn, "SELECT * FROM product WHERE product_id>25 AND brand='Samsung Tab'");
    while ($row = mysqli_fetch_assoc($sql)) {
        echo "
                ...
                <div class=\"GlaxyTabS8Ultra text-big-width\" data-aos=\"fade-up\" data-aos-duration=\"1500\">
                    ...
                    <p class=\"price-white\">From $" . $row['price'] . "
                    </p>
                    <div class=\"buy-learnmore\">
                        <form action=\"../php/addOrder.php\" method=\"post\">
                        ...
                        <a href=\"../changeable-page.php?product_id=" . $row['product_id'] . "\" class=\"more-info btn-learn-GalaxyTabS6Lite\">Learn more ></a>
                    </div>
                </div>
                <img class=\"GalaxyTabS6Lite-Image\" src=\"../ProductsImages/" . $row['image'] . "\" data-aos=\"fade-up\" data-aos-duration=\"1500\">
            </div>";
    }
