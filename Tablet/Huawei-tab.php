...
<head>
    ...
    <link rel="stylesheet" href="../css/huawei-tab.css">
...
<body>
    ...
    <nav class="nav-bar">
        <div class="ul">
            ...
            <div class="dropdown" data-dropdown>
                ...
                <a class="linked nav-btn link procent linkuri-nav" href="Samsung-tab.php" target="_self">Samsung Tablet</a>
                <a class="linked nav-btn link procent linkuri-nav" href="Huawei-tab.php" target="_self">Huawei Tablet</a>
            </div>
    ...
    <div class="container-1">
        <img class="HuaweiMatePadPro-Image Image1" src="<?php
                                                        $product_id = 23;
                                                        include '../php/product.php';
                                                        echo $image;
                                                        ?>" alt="HuaweiMatePadPro">
        <div class="HuaweiMatePadPro text-big-width text-pos-1">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    ...
                    <input class="btn-buy-white black btn-buy-HuaweiMatePadPro" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiMatePadPro">Learn more ></a>
            </div>
        </div>
    </div>

    <div class="container-1 container-black">
        <div class="HuaweiMatePadPro text-big-width" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white btn-buy-HuaweiMatePad11" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiMatePad11">Learn more ></a>
            </div>
        </div>
        <img class="HuaweiMatePad11-Image" src="<?php
                                                echo $image;
                                                ?>" alt="HuaweiMatePad11" data-aos="fade-left" data-aos-duration="1500">
    </div>

    <div class="container-1">
        <img class="HuaweiMatePadPro-Image" src="<?php
                                                    $product_id = 25;
                                                    include '../php/product.php';
                                                    echo $image;
                                                    ?>" alt="HuaweiMatePadPaper" data-aos="fade-right" data-aos-duration="1500">
        <div class="HuaweiMatePadPro text-big-width-1 text-pos-1" data-aos="fade-up" data-aos-duration="1500">
            <p class="name-white black"><?php
                                        echo $brand . " " . $model_name;
                                        ?></p>
            <p class="description-white black"><?php
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white black btn-buy-HuaweiMatePaper" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiMatePaper">Learn more ></a>
            </div>
        </div>
    </div>
    ...
    <?php
    include '../php/product.php';
    $sql = mysqli_query($conn, "SELECT * FROM product WHERE product_id>25 AND brand='Huawei MatePad'");
    while ($row = mysqli_fetch_assoc($sql)) {
        echo "<div class=\"container-1 container-black\">
                    <div class=\"HuaweiMatePadPro text-big-width\" data-aos=\"fade-up\" data-aos-duration=\"1500\">
                        ...
                        <div class=\"buy-learnmore\">
                            ...
                            <a href=\"../changeable-page.php?product_id=" . $row['product_id'] . "\" class=\"more-info btn-learn-HuaweiMatePad11\">Learn more ></a>
                        </div>
                    </div>
                    <img class=\"HuaweiMatePad11-Image\" src=\"../ProductsImages/" . $row['image'] . "\" data-aos=\"fade-left\" data-aos-duration=\"1500\">
                </div>";
    }
