...
<head>
    ...
    <link rel="stylesheet" href="../css/huawei-mob.css">
...
<body>
    ...
    <div class="container-1">
        <div class="HuaweiP50 text-big-width poket50">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    ...
                    <input class="btn-buy-white black btn-buy-HuaweiP50Pocket" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiP50Pocket">Learn more ></a>
            </div>
        </div>
        <img class="HuaweiP50-Image" src="<?php
                                            echo $image
                                            ?>" alt="HuaweiP50">
    </div>

    <div class="container-1 container-black">
        <img class="HuaweiNova9-Image" src="<?php
                                            $product_id = 18;
                                            include '../php/product.php';
                                            echo $image
                                            ?>" alt="HuaweiNova9" data-aos="fade-right" data-aos-duration="1500">
        <div class="HuaweiP50" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white btn-buy-HuaweiNova9" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiNova9">Learn more ></a>
            </div>
        </div>
    </div>

    <div class="container-1">
        <div class="HuaweiP50 text-big-width" data-aos="fade-up" data-aos-duration="1500">
            <p class="name-white black"><?php
                                        $product_id = 19;
                                        include '../php/product.php';
                                        echo $brand . " " . $model_name;
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white black btn-buy-HuaweiP30Pro" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-HuaweiP30Pro">Learn more ></a>
            </div>
        </div>
        <img class="HuaweiP30-Image" src="<?php
                                            echo $image
                                            ?>" alt="HuaweiP30" data-aos="fade-up" data-aos-duration="1500">
    </div>

    <?php
    include '../php/product.php';
    $sql = mysqli_query($conn, "SELECT * FROM product WHERE product_id>25 AND brand='Huawei'");
    while ($row = mysqli_fetch_assoc($sql)) {

        echo "
                    <div class=\"container-1 container-black\">
                    <img class=\"HuaweiNova9-Image\" src=\"../ProductsImages/" . $row['image'] . "\" data-aos=\"fade-right\" data-aos-duration=\"1500\">
                    <div class=\"HuaweiP50\" data-aos=\"fade-up\" data-aos-duration=\"1500\">
                        ...
                        <div class=\"buy-learnmore\">
                            ...
                            <a href=\"../changeable-page.php?product_id=" . $row['product_id'] . "\" class=\"more-info btn-learn-HuaweiNova9\">Learn more ></a>
                        </div>
                    </div>
                </div>
            ";
