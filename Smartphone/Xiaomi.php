...
<body>
    ...
    <div class="container-1">
        <img class="Xiaomi12Pro-Image" src="<?php
                                            $product_id = 10;
                                            include '../php/product.php';
                                            echo $image;
                                            ?>" alt="Xiaomi12Pro">
        <div class="Xiaomi12Pro">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    ...
                    <input class="btn-buy-white black btn-buy-Xiaomi12Pro" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-Xiaomi12Pro">Learn more ></a>
            </div>
        </div>
    </div>

    <div class="container-1 black-container">
        <div class="Xiaomi12Pro" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white btn-buy-Xiaomi12" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-Xiaomi12">Learn more ></a>
            </div>
        </div>
        <img class="Xiaomi12-Image" src="<?php
                                            echo $image;
                                            ?>" alt="Xiaomi12" data-aos="fade-left" data-aos-duration="1500">
    </div>
    ...
    <div class="container-1">
        <img class="Xiaomi12Pro-Image" src="<?php
                                            ...
                                            include '../php/product.php';
                                            echo $image;
                                            ?>" alt="Xiaomi11LiteNE" data-aos="fade-right" data-aos-duration="1500">
        <div class="Xiaomi12Pro" data-aos="fade-up" data-aos-duration="1500">
            <p class="name-white black"><?php
                                        echo $brand . " " . $model_name;
                                        ?></p>
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white black btn-buy-Xiaomi11liteNE" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-Xiaomi11liteNE">Learn more ></a>
            </div>
        </div>
    </div>
    ...
    <div class="container-1 black-container">
        <div class="Xiaomi12Pro" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="buy-learnmore">
                <form action="../php/addOrder.php" method="post">
                    <input type="hidden" name="product_id" value="<?php echo $product_id; ?>">
                    <input class="btn-buy-white btn-buy-Redmi10" type="submit" value="Buy">
                </form>
                <a href="../changeable-page.php?product_id=<?php
                                                            echo $product_id;
                                                            ?>" class="more-info btn-learn-Redmi10">Learn more ></a>
            </div>
        </div>
        <img class="Xiaomi12-Image" src="<?php
                                            echo $image;
                                            ?>" alt="Redmi10" data-aos="fade-left" data-aos-duration="1500">
    </div>

    <?php
    include '../php/product.php';
    $sql = mysqli_query($conn, "SELECT * FROM product WHERE product_id>25 AND brand='Xiaomi'");
    while ($row = mysqli_fetch_assoc($sql)) {

        echo "
                <div class=\"container-1\">
                <img class=\"Xiaomi12Pro-Image\" src=\"../ProductsImages/" . $row['image'] . "\" data-aos=\"fade-right\" data-aos-duration=\"1500\">
                <div class=\"Xiaomi12Pro\" data-aos=\"fade-up\" data-aos-duration=\"1500\">
                    <p class=\"name-white black\">" . $row['brand'] . " " . $row['model_name'] . "</p>
                    <p class=\"description-white black\">" . $row['mini_description'] . "</p>
                    <p class=\"price-white black\">From $" . $row['price'] . "</p>
                    <div class=\"buy-learnmore\">
                        <form action=\"../php/addOrder.php\" method=\"post\">
                                <input type=\"hidden\" name=\"product_id\" value=\"" . $row['product_id'] . "\">
                                <input class=\"btn-buy-white black btn-buy-Xiaomi11liteNE\" type=\"submit\" value=\"Buy\">
                        </form>
                        <a href=\"../changeable-page.php?product_id=" . $row['product_id'] . "\" class=\"more-info btn-learn-Xiaomi11liteNE\">Learn more ></a>
                    </div>
                </div>
            </div>
                ";
