...
<head>
    ...
    <link rel="stylesheet" href="css/aboutastro.css">
    <link rel="stylesheet" href="css/style1.css">
    <link rel="stylesheet" href="css/navbar.css">
    <link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.1.1/css/all.min.css">
    <title>About Astro</title>
</head>
...
<body>
    ...
    <div class="container-1">
        <p class="text-sect-1">Technology as<br>an art form.</p>
    </div>

    <video class="video-1" muted loop autoplay>
        <source src="assets/video-3.mp4">
    </video>

    <div class="container-2">
        <p class="text-sect-2" data-aos="fade-up" data-aos-duration="1500">The largest innovative<br>store in the world.</p>
    </div>
    <div class="container-3">
        <div class="slider-frame">
            <div class="slide-images">
                <div class="img-container">
                    <img class="slide" src="assets/slide-1.jpg">
                </div>
                <div class="img-container">
                    <img class="slide" src="assets/slide-2.jpg">
                </div>
                <div class="img-container">
                    <img class="slide" src="assets/slide-3.jpg">
                </div>
            </div>
        </div>
        <div class="text-3 space-cont" data-aos="fade-up" data-aos-duration="1500">
            <div class="margin-text child-1">
                <p class="text-sect-3 text-sect-3-bold margin-text-1">Vision</p>
                <p class="text-sect-3 margin-text-1">We strive to be a sustainable company that contributes to a better world.</p>
                <span class="margin-text-1"></span>
            </div>
            <div class="margin-text child-2">
                <p class="text-sect-3 text-sect-3-bold margin-text-1">Mission</p>
                <p class="text-sect-3 margin-text-1">We exist to elevate life through technological artistry.</p>
                <span class="margin-text-1"></span>
            </div>
            <div class="margin-text child-3">
                <p class="text-sect-3 text-sect-3-bold margin-text-1">Values</p>
                <p class="text-sect-3 margin-text-1">Benfen | User-led | Aim for perfection | Goal-oriented.</p>
                <span class="margin-text-1"></span>
            </div>
        </div>
    </div>
