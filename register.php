...
<body>
    ...
    <div class="section-1">
        <div class="pannel">
            ...
            <div class="pannel-sect-2">

                <form class="form" action="" enctype="multipart/form-data">
                    <div class="form-sections error">
                        <p>Error</p>
                    </div>
                    <div class="form-sections two-section">
                        <label for="firstName">First Name
                            <input type="text" name="firstName" placeholder="First Name" class="long-input" required>
                        </label>
                        <label for="lastName">Last Name
                            <input type="text" name="lastName" placeholder="Last Name" class="long-input" required>
                        </label>
                    </div>

                    <div class="form-sections">
                        <label for="email">Email
                            <input type="text" name="email" placeholder="Enter Your Email" class="long-input" required>
                        </label>
                    </div>

                    <div class="form-sections">
                        <label for="phone">Phone
                            <input type="text" name="phone" class="long-input" placeholder="Phone Number" required pattern="[0-9]{11}" oninvalid="this.setCustomValidity('Enter 11 digits Number')" oninput="this.setCustomValidity('')">
                        </label>
                    </div>
                    ...
                    <div class="form-sections two-section">
                        ...
                        <label for="confirmPassword">Confirm Password
                            <input type="password" name="confirmPassword" placeholder="Confirm Password" class="long-input" required>
                        </label>
                    </div>

                    <div class="form-sections">
                        <input type="submit" class="submit long-input" value="Signup Now">
                    </div>
